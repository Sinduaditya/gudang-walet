            ...
            <div class="space-y-8">
                ...
                <div id="formTab" class="tab-content">
                    <div class="bg-white rounded-xl shadow-md border border-gray-200">
                        ...
                        <form action="{{ route('barang.keluar.receive-external.store-step1') }}" method="POST"
                            class="p-6">
                            @csrf
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1.5 text-xs text-gray-500">
                                                ...
                                                Barang akan diterima di Gudang Utama (otomatis)
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div id="historyTab" class="tab-content hidden">
                    <div class="bg-white rounded-xl shadow-md border border-gray-200">
                        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-lg font-semibold text-gray-900">Riwayat Penerimaan External</h2>
                                    <p class="text-sm text-gray-500 mt-1">Daftar penerimaan barang dari jasa cuci eksternal
                                    </p>
                                </div>
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                                <div class="text-sm font-semibold text-teal-600">
                                                    +{{ number_format(abs($tx->quantity_change_grams), 0, ',', '.') }} gr
                                                </div>
