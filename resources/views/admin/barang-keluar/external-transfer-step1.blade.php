        ...
        <div id="progressSteps" class="mb-8 bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center justify-between max-w-3xl mx-auto">
                <div class="flex flex-col items-center flex-1">
                    <div class="w-10 h-10 flex items-center justify-center rounded-full bg-green-500 text-white font-semibold text-base shadow-sm">
                        1
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="relative">
                                ...
                                <div class="hidden md:flex absolute left-1/2 top-12 -translate-x-1/2 z-10">
                                    <div class="bg-green-100 rounded-full p-2 border-2 border-white shadow-md">
                        ...
                        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                            <div class="flex items-center justify-between">
                                <div class="text-sm text-gray-600">
                                    Menampilkan {{ $transferExternalTransactions->firstItem() }} - {{ $transferExternalTransactions->lastItem() }} dari {{ $transferExternalTransactions->total() }} transaksi
                                </div>
                                <div>
