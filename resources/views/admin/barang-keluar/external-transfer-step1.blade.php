...
@section('title', 'Transfer External - Step 1')
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="button" onclick="toggleHistoryTab()" id="historyToggleBtn"
                        class="inline-flex items-center px-4 py-2 border border-green-300 text-sm font-medium rounded-lg text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span id="historyToggleText">Daftar Transfer External</span>
                    </button>
            ...
            <div id="progressSteps" class="mb-8 bg-white rounded-lg shadow-sm border p-6">
                <div class="flex items-center justify-between max-w-3xl mx-auto">
                    <div class="flex flex-col items-center flex-1">
                        <div
                            class="w-10 h-10 flex items-center justify-center rounded-full bg-green-500 text-white font-semibold text-base shadow-sm">
                            1
                        </div>
                        <span class="mt-2 text-xs sm:text-sm font-medium text-green-600">
                            Data Transfer
                        </span>
                    </div>
                ...
                <div id="formTab" class="tab-content">
                    <div class="bg-white rounded-xl shadow-md border border-gray-200">
                        <div class="px-6 py-4 border-b border-gray-200">
                            ...
                            <p class="text-sm text-gray-500 mt-1">Kirim barang dari Gudang Utama ke lokasi Jasa Cuci
                                eksternal</p>
                        </div>

                        <form id="externalTransferForm" action="{{ route('barang.keluar.external-transfer.store') }}"
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                    ...
                                    <div class="mt-3 flex justify-end gap-2">
                                        ...
                                        <button type="submit" formmethod="GET" formaction="{{ route('barang.keluar.external-transfer.step1') }}"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-2">
                                            <input type="number" name="weight_grams" id="weight_grams"
                                                value="{{ old('weight_grams') }}" step="0.01" min="0"
                                    ...
                                    <div>
                                        ...
                                        <p id="total-deduction-info"
                                            class="mt-2 text-sm text-gray-600 font-medium hidden"></p>
                                        @error('susut_grams')
                                            <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md border border-gray-200">
                        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <form action="{{ route('barang.keluar.external-transfer.step1') }}" method="GET"
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="start_date" id="start_date"
                                            ...
                                            class="w-full md:w-auto text-sm border-gray-300 rounded-md px-3 py-2 focus:ring-green-500 focus:border-green-500">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="supplier_id" id="supplier_id" class="w-full md:w-auto text-sm border-gray-300 rounded-md px-3 py-2 focus:ring-green-500 focus:border-green-500">
                                    ...
                                    <div>
                                        ...
                                        <select name="grade_company_id" id="grade_company_id" class="w-full md:w-auto text-sm border-gray-300 rounded-md px-3 py-2 focus:ring-green-500 focus:border-green-500">
                        ...
                        @if(isset($summary) && $summary->count() > 0)
                            <div class="px-6 py-4 bg-green-50 border-b border-green-100">
                                <h4 class="text-sm font-semibold text-green-800 mb-2">Total Stok Ditransfer per Grade (Sesuai Filter)</h4>
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                ...
                                                @if ($stockTransfer && $stockTransfer->fromLocation)
                                                    <div class="flex items-center">
                                                        ...
                                                        <svg class="w-4 h-4 mx-2 text-green-600" fill="none"
                                                            stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                                        </svg>
                                                        <span
                                                            class="text-green-700 font-medium">{{ $stockTransfer->toLocation->name ?? '-' }}</span>
                                                    </div>
                                                @else
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                <div class="flex justify-center items-center space-x-2">
                                                    <a href="{{ route('barang.keluar.external-transfer.edit', $stockTransfer->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('barang.keluar.external-transfer.destroy', $stockTransfer->id) }}"
                                                        method="POST"
                                        ...
                                        <tr>
                                            <td colspan="7" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <p class="text-gray-500 font-medium">Belum ada pengiriman ke Jasa Cuci
                                                    </p>
                                                    <p class="text-gray-400 text-sm mt-1">Transaksi akan muncul setelah
                                                        Anda mengirim barang ke Jasa Cuci</p>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
                            ...
                            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                                <div class="flex items-center justify-between">
                                    <div class="text-sm text-gray-600">
                                        Menampilkan {{ $transferExternalTransactions->firstItem() }} -
                                        {{ $transferExternalTransactions->lastItem() }} dari
                                        {{ $transferExternalTransactions->total() }} transaksi
                                    </div>
                                    <div>
                                        {{ $transferExternalTransactions->links() }}
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="mt-3 text-center w-full">
                            ...
                            <div class="mt-4 text-left">
                                <div class="bg-gray-50 rounded-lg p-4 space-y-3 text-sm">
                                    ...
                                    <div class="flex justify-between">
                                        <span class="text-gray-500">Tujuan (Jasa Cuci):</span>
        ...
        <script>
            function toggleHistoryTab() {
                ...
                if (historyTab.classList.contains('hidden')) {
                    ...
                    toggleBtn.classList.remove('bg-green-50', 'text-green-700', 'border-green-300');
                    ...
                    toggleText.textContent = 'Daftar Transfer External';
            ...
            function calculateTotalDeduction() {
                ...
                if (total > 0) {
                    infoEl.textContent =
                        `Total pengurangan stok: ${new Intl.NumberFormat('id-ID').format(total)} gr (Transfer: ${weight} + Susut: ${susut})`;
            ...
            function showConfirmationModal() {
                ...
                // For external transfer, to_location_id is the external location
                ...
                document.getElementById('modal-total').textContent = new Intl.NumberFormat('id-ID').format(weight + susut) +
                    ' gr';
