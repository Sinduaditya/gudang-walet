                                    ...
                                    <select name="grade_company_id" required
                                        ...
                                        @foreach ($gradesWithStock as $grade)
                                            <option value="{{ $grade['id'] }}"
                                                ...
                                                {{ $grade['name'] }} (Stok:
                                                {{ number_format($grade['total_stock_grams'], 0, ',', '.') }} gr)
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <form action="{{ route('barang.keluar.external-transfer.step1') }}" method="GET"
                                    ...
                                    <div>
                                        <label for="start_date" class="block text-xs font-medium text-gray-700 mb-1">Dari
                                            Tanggal</label>
                                    ...
                                    <div>
                                        <label for="end_date" class="block text-xs font-medium text-gray-700 mb-1">Sampai
                                            Tanggal</label>
                                    ...
                                    <div class="flex gap-2">
                                        <button type="submit"
                                            class="px-3 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
                                            Filter
                                        </button>

                                        @if (request('start_date') || request('end_date'))
                                            <a href="{{ route('barang.keluar.external-transfer.step1') }}"
                                                class="px-3 py-2 bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors">
                                                Reset
                                            </a>
                                        @endif
                                    </div>
