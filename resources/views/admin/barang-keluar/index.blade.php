    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            class="group bg-white rounded-xl shadow-md p-8 border-2 border-transparent hover:border-teal-500 hover:shadow-xl transition-all duration-300">
                <div class="flex items-center mb-4">
                    <div class="w-14 h-14 bg-teal-100 rounded-lg flex items-center justify-center group-hover:bg-teal-500 transition-all duration-300">
                    ...
                    <h3 class="ml-4 text-xl font-bold text-gray-800 group-hover:text-teal-600 transition-all duration-300">
                        Terima External
                    </h3>
                </div>
                <p class="text-gray-600 mb-4">Terima barang kembali dari jasa cuci eksternal.</p>
                <div class="flex items-center text-teal-600 font-medium group-hover:translate-x-2 transition-all duration-300">
                    Terima Barang
                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
