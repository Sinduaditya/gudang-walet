...
@section('title', 'Transfer External - Konfirmasi')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center justify-between max-w-3xl mx-auto">
                ...
                <div class="flex-1 h-0.5 bg-green-600 mx-2 sm:mx-4 -mt-6"></div>
                <div class="flex flex-col items-center flex-1">
                    <div class="w-10 h-10 flex items-center justify-center rounded-full bg-green-500 text-white font-semibold text-sm shadow-sm">2</div>
                    <span class="mt-2 text-xs sm:text-sm font-medium text-green-600">Konfirmasi</span>
                </div>
            </div>
        </div>

        <form action="{{ route('barang.keluar.external-transfer.store') }}" method="POST">
            @csrf

            <!-- Confirmation Card -->
            <div class="bg-white rounded-xl shadow-md border border-gray-200 mb-6">
                <div class="px-6 py-4 border-b border-gray-200 bg-green-50">
                    <h2 class="text-lg font-semibold text-gray-900">Detail Transfer External</h2>
