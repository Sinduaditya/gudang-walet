...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
    ...
    {{-- tampilkan teks saja --}}
    <div class="p-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-700 font-medium">
        Gudang Utama
    </div>
                                    ...
                                    <tr>
                                        <td colspan="4" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <p class="text-gray-400 text-sm mt-1">Transaksi akan muncul setelah Anda melakukan penjualan</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
                        ...
                        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                            <div class="flex items-center justify-between">
                                <div class="text-sm text-gray-600">
                                    Menampilkan {{ $penjualanTransactions->firstItem() }} - {{ $penjualanTransactions->lastItem() }} dari {{ $penjualanTransactions->total() }} transaksi
                                </div>
                                <div>
