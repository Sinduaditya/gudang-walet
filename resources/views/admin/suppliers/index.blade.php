    ...
    <div class="bg-white min-h-screen">
        <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-semibold text-gray-800">Manajemen Supplier</h1>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
                    ...
                    <div class="flex-1 max-w-md">
                        ...
                        <input type="text" id="searchInput" placeholder="Cari berdasarkan nama, alamat, atau kontak..."
                            onkeyup="searchTable()"
                    ...
                    <div class="bg-white px-6 py-4 border-t border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-700">
                                Showing {{ $suppliers->firstItem() }}-{{ $suppliers->lastItem() }} of
    ...
    <div id="deleteModal" class="hidden fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mt-4">Hapus Supplier</h3>
                <p class="text-sm text-gray-500 mt-2">
                    Apakah Anda yakin ingin menghapus supplier <span id="supplierName"
    ...
    <script>
        ...
        function searchTable() {
            ...
            for (let i = 1; i < tr.length; i++) {
                ...
                const tdContact = tr[i].getElementsByTagName('td')[3];

                if (tdName && tdAddress && tdContact) {
                    const nameValue = tdName.textContent || tdName.innerText;
                    const addressValue = tdAddress.textContent || tdAddress.innerText;
                    const contactValue = tdContact.textContent || tdContact.innerText;
