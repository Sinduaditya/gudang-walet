            ...
            <div class="bg-white shadow-sm border rounded-lg overflow-hidden mb-6">
                ...
                <div class="px-6 pb-6 border-b border-gray-200 bg-gray-50 pt-4">
                     <form action="{{ route('barang.keluar.transfer-idm.create') }}" method="GET">
                        <!-- Preserve Transfer Date in URL if needed, OR just rely on the main form input default -->
                        <!-- Actually, if we filter, the page reloads. The "Transfer Date" input in Main Form might reset if not persisted.
                             So we should pass 'transfer_date' in the GET request too to keep it synced.
                        -->
                             ...
                             <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                ...
                                <div>
                                    <select name="grade_company_id" id="grade_company_id"
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <option value="">Semua Grade Company</option>
                                ...
                                <div>
                                    <select name="grade_idm_name"
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <option value="">Semua Grade IDM</option>
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="submit"
                                        class="px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium transition duration-200">
                                        Filter
                                    </button>
                                    <a href="{{ route('barang.keluar.transfer-idm.create') }}"
                                        class="px-4 py-2.5 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 text-sm font-medium transition duration-200">
                                        Reset
                                    </a>
                                </div>
                             </div>
                                    ...
                                    <div class="border-2 border-gray-200 rounded-xl p-4 transition-all duration-200 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-gray-300 hover:shadow-md h-full flex flex-col items-center text-center">
                                        ...
                                        <div class="mt-auto w-full pt-2 border-t border-gray-100 space-y-1">
                                            <div class="flex justify-between text-xs">
                                                ...
                                                <span class="font-medium text-gray-900">{{ $item->weight }} Kg</span>
                                            </div>
                                            <div class="flex justify-between text-xs">
                                                <span class="text-gray-500">Harga:</span>
                                                <span class="font-medium text-gray-900">{{ number_format($item->total_price, 0, ',', '.') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </label>
