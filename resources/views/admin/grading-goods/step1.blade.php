...
<div class="bg-white min-h-screen">
    <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="{{ route('grading-goods.step1.store') }}" id="mainForm">
            @csrf
            <div class="bg-white shadow-sm border rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4">
                        <div class="relative">
                            <input type="text"
                                id="itemSearch"
                                placeholder="Cari di hasil filter..."
                ...
                <div class="px-6 pb-6">
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar" id="itemGrid">
                        ...
                        <label class="receipt-item-card relative cursor-pointer group"
                            ...
                            <input type="radio"
                                ...
                                value="{{ $ri->id }}"
                                form="mainForm"
                                {{ old('receipt_item_id') == $ri->id ? 'checked' : '' }}
                                required
                        ...
                        @empty
                            <div class="col-span-full text-center py-12">
                                ...
                                <p class="text-xs text-gray-400 mt-1">Coba gunakan filter 'Nama Grade Supplier' di atas.</p>
                            </div>
                        @endforelse
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initial check on page load for previously selected radio
