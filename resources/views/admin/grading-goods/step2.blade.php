    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Lengkapi hasil grading untuk item yang dipilih (Multiple Grade).</p>
            </div>
            ...
            <div class="bg-white shadow-sm border rounded-lg p-6">
                ...
                <div id="gradesContainer">
                    ...
                    @if(old('grades'))
                        @foreach(old('grades') as $index => $grade)
                            <div class="grade-row border border-gray-200 rounded-lg p-4 mb-4" data-index="{{ $index }}">
                                @include('admin.grading-goods.partials.grade-row', ['index' => $index, 'grade' => $grade])
                            </div>
                        @endforeach
                    @else
                        <div class="grade-row border border-gray-200 rounded-lg p-4 mb-4" data-index="0">
                            @include('admin.grading-goods.partials.grade-row', ['index' => 0, 'grade' => []])
                        </div>
                    @endif
                </div>
                ...
                <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="mt-2 text-xs text-gray-500">
                        Berat asal: <span class="font-medium">{{ number_format($sortingResult->receiptItem->warehouse_weight_grams ?? 0) }} gram</span>
